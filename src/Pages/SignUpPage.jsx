  ...
  return (
    <div className="container mt-5">
      <div className="w-50 mx-auto">
        <div className="text-center">
          ...
          <Form.Group controlId="formBasicEmail">
            <Form.Label> <h5>Social Sign-up </h5> </Form.Label>
          </Form.Group>         
           </div>
          </div>
      ...
      Sign in with Google
        ...
        <a  href="/SignIn" className='text-decoration-none'> <h4  className="text-dark poppins-font">Already have an account? [Sign In]</h4>       </a>
          </div>
      </div>
    </div>
  );
